...
fn blocking_google_ch(cache_dir: String) -> Result<String>{
...
async fn connect_google_ch(cache_dir: String) -> Result<String> {
    ...
    let stream = tor.connect("google.ch", 80, None).await?;
